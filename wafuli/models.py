...
class InvestLog(models.Model):
    ...
    invest_amount = models.DecimalField(u'投资金额(1)', max_digits=10, decimal_places=2, blank=True, null=True)
    invest_term = models.IntegerField(u"投资标期(2)", blank=True, null=True)
    ...
    expect_amount = models.DecimalField(u'用户预期返现金额(8)', max_digits=10, decimal_places=2, default=0, null=True)
